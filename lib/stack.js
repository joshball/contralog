...
var getFuncOrMethodName = function(stackNum){
    return getStackNum(stackNum).getFunctionName() || getStackNum(stackNum).getMethodName();
};
...
module.exports = {
    ...
    getFuncOrMethodName: getFuncOrMethodName,
