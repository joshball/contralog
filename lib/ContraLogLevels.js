...
var i = 0;
var defaultLevels = {
    trace: {name: 'trace', num: i++, color: 'whiteBright', lineFormat: '\n[#mod:#line <#func>] #msg'},
    debug: {name: 'debug', num: i++, color: 'cyanBright'},
    info: {name: 'info', num: i++, color: 'greenBright'},
    warn: {name: 'warn', num: i++, color: 'yellowBright'},
    error: {name: 'error', num: i++, color: 'redBright', isError: true, lineFormat: '#all'},
    exception: {name: 'exception', num: i++, color: 'red', isError: true, lineFormat: '#all' }
};
